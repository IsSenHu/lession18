    ...
    * */
    ...
    public static String parseQRCode(String filePath){
        ...
        try{
            ...
            logger.error("result为：" + result.toString());
            logger.error("resultFormat为：" + result.getBarcodeFormat());
            logger.error("resultText为：" + result.getText());
            //设置返回值
...
//        logger.error("随机生成的12位的验证码为：" + text);
